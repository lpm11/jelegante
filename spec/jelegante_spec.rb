...
describe "Jelegante" do
  context "JapaneseGuesser" do
    it "Guessing japanese is true-positive" do
      texts = [
      ...
      texts.map { |text| Jelegante.japanese?(text) }.all?
    end
    
    it "Guessing non-japanese is false-negative" do
      texts = [
